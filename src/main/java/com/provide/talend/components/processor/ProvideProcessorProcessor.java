...
public class ProvideProcessorProcessor implements Serializable {
    private final ProvideProcessorProcessorConfiguration configuration;
    private final ProvideGoldmineService service;

    public ProvideProcessorProcessor(@Option("configuration") final ProvideProcessorProcessorConfiguration configuration,
