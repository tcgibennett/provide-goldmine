...
@PartitionMapper(name = "ProvideInput")
@Documentation("TODO fill the documentation for this mapper")
public class ProvideInputMapper implements Serializable {
    private final ProvideInputMapperConfiguration configuration;
    private final ProvideGoldmineService service;
    private final RecordBuilderFactory recordBuilderFactory;

    public ProvideInputMapper(@Option("configuration") final ProvideInputMapperConfiguration configuration,
    ...
    @Split
    public List<ProvideInputMapper> split(@PartitionSize final long bundles) {
        ...
        // In this case bundles = 100 and we must try to return 10 ProvideInputMapper with 1/10 of the overall work each.
        //
    ...
    @Emitter
    public ProvideInputSource createWorker() {
        // here we create an actual worker,
        // you are free to rework the configuration etc but our default generated implementation
        // propagates the partition mapper entries.
        return new ProvideInputSource(configuration, service, recordBuilderFactory);
    }
}