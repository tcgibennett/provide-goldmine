package com.provide.talend.components.processor;
...
public class ProvideProcessorProcessorTest {

    @ClassRule
    public static final SimpleComponentRule COMPONENT_FACTORY = new SimpleComponentRule("com.provide.talend.components");
    ...
    public void map() throws IOException {
        ...
        final ProvideProcessorProcessorConfiguration configuration =  new ProvideProcessorProcessorConfiguration();

        // We create the component processor instance using the configuration filled above
        final Processor processor = COMPONENT_FACTORY.createProcessor(ProvideProcessorProcessor.class, configuration);
