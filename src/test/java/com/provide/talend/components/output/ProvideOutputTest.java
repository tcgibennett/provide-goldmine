...
public class ProvideOutputTest {
    ...
    public void map() throws IOException {
        ...
        final ProvideOutputConfiguration configuration =  new ProvideOutputConfiguration()
                                                                                /* .setDataset() */;

        // We create the component processor instance using the configuration filled above
        final Processor processor = COMPONENT_FACTORY.createProcessor(ProvideOutput.class, configuration);
